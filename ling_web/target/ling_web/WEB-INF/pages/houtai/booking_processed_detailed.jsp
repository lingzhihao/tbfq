        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label  class="field prepend-icon"><h4>受理状态：</h4><span class="badge badge-system mr10 fs11">${detailed.bYduty}</span></label>
                            </div>
                            <div class="col-md-6">
                                <label  class="field prepend-icon"><h4>受理人：</h4><span class="badge badge-system mr10 fs11">${detailed.employee.eName}</span></label>
                            </div>
                        </div>
                        <div class="panel-footer text-right">
                            <a href="<c:url value="/houtai/booking/to_processed_update?bYno=${detailed.bYno}"/>"><button class="button"> 修改 </button></a>
                            <a onclick="return confirm('将要退订 订单 为${detailed.bYno}，是否继续？')" href="<c:url value="/houtai/booking/remove?bYno=${detailed.bYno}"/>"><button class="button"> 退订 </button></a>
