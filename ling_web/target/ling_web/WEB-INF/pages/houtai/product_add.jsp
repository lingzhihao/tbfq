    ...
    window.onload = function (ev) {
            ...
            thumbnail.addEventListener("change", function () {
                ...
                reader.onload = function () {
                    selectImg.src = this.result;//读取完成后，将结果赋值给img的src
                ...
                <form action="<c:url value="/houtai/product/add"/>"   id="adForm" method="post" enctype="multipart/form-data">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>内景：</h4><input type="text" name="pNj" class="form-control gui-input"  maxlength="50" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>外景：</h4><input type="text" name="pWj" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>拍摄数量：</h4><input type="text" name="pPssl" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>底片：</h4><input type="text" name="pDp" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>服务人员：</h4><input type="text" name="pFwry" class="form-control gui-input" maxlength="70" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>服务时间：</h4><input type="text" name="pFwsj" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>造型套数：</h4><input type="text" name="pZxts" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>化妆用品：</h4><input type="text" name="pHzyp" class="form-control gui-input"  maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>拍摄道具：</h4><input type="text" name="pPsdj" class="form-control gui-input"  maxlength="50" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>相册：</h4><input type="text" name="pXc" class="form-control gui-input"  maxlength="70" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>相框：</h4><input type="text"  name="pXk"class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>摆台：</h4><input type="text" name="pBt" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>展架：</h4><input type="text" name="pZj" class="form-control gui-input" maxlength="505" required>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>赠送商品：</h4><input type="text"name="pZssp" class="form-control gui-input" maxlength="50" required>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label  class="field prepend-icon">
