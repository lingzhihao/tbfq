            ...
            <form action="<c:url value="/ling/add_order"/>" method="post" class="form-horizontal" style="margin-top: 5px;">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="submit" width="100" value="提交" style="background: url('<c:url value="/images/register.gif"/>') no-repeat scroll 0 0 rgba(0, 0, 0, 0); height: 35px; width: 100px; color: white;">
                    </div>
                </div>
            </form>
        </div>
