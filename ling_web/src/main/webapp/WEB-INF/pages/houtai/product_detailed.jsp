                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label  class="field prepend-icon">
                                    <h4> 封面图片：</h4><img src="<c:url value="${detailed.pImg}"/>"width="70px" height="70px">
                                </label>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>套餐图片：</h4>
                                    <img src="<c:url value="${detailed.productImg.gImage1}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productImg.gImage2}"/> " width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productImg.gImage3}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productImg.gImage4}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productImg.gImage5}"/>" width="70px" height="70px">
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label  class="field prepend-icon">
                                    <h4>轮套餐播图片：</h4>
                                    <img src="<c:url value="${detailed.productLunBo.lImage1}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productLunBo.lImage2}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productLunBo.lImage3}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productLunBo.lImage4}"/>" width="70px" height="70px">
                                    <img src="<c:url value="${detailed.productLunBo.lImage5}"/>" width="70px" height="70px">
                                </label>
                            </div>
                        </div>
