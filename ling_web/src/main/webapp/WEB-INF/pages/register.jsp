        ...
        $.ajax({
            ...
            success:function(data){
                if (data == 0) {//后端传来的msg的值是no,不能注册。反之。
                    $("#remind").html("<font color='red'>用户名已存在</font>");
                }if(data == 1){
...
<div class="container"
    ...
    <div class="row">
        ...
        <div class="col-md-8"
            ...
            <form action="<c:url value="/ling/register"/>" method="post" class="form-horizontal" style="margin-top: 5px;">
                <div class="form-group">
                    <label for="uName" class="col-sm-2 control-label">用户名</label>
                    <div class="col-sm-6">

                        <input type="text" class="form-control" id="uName" name="uName" onblur="ajaxValidate()"
                               placeholder="请输入用户名">
                        <span id="remind" color="red"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="uRelname" class="col-sm-2 control-label">姓名</label>
                    <div class="col-sm-6">

                        <input type="text" class="form-control" id="uRelname" name="uRelname"
                               placeholder="请输入您的姓名">
                    </div>
                </div>
                ...
                <div class="form-group opt">
                    <label for="uAddress" class="col-sm-2 control-label">联系地址</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" width="100"
                               style="background: url('<c:url value="/images/register.gif"/>') no-repeat scroll 0 0 rgba(0, 0, 0, 0); height: 35px; width: 100px; color: white;">注册</button>
                    </div>
                </div>
            </form>
        </div>
