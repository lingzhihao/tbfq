    ...
    <div class="container panel panel-danger" >
        ...
        <div class="col-md-8" style="margin-top: 20px">
            <div class="panel heading-border" >
                <form action="/ling/change_password" method="post" class="form-horizontal col-sm-offset-3" enctype="multipart/form-data">
              ...
              <%--  <form method="post" action="/ling/change_password" id="admin-form">
                    <div class="form-group col-md-8" style="text-align: center">
                        <input type="password" name="old" id="old" class=" form-control required" placeholder="原始密码...">
                    </div>
                    <div class="form-group col-md-8" style="text-align: center">
                        <input type="password" name="new1" id="new1" class="form-control required" placeholder="新密码...">
                    </div>
                    <div class="form-group col-md-8" style="text-align: center">
                        <input type="password" name="new2" id="new2" class="form-control required" placeholder="重复新密码...">
                    </div>
                    <div class="form-group col-md-8" style="text-align: center">
