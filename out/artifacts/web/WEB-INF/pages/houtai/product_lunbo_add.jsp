        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            ...
            <div class="panel-body bg-light">
                ...
                <div class="panel-body pn">
                    <form action="<c:url value="/houtai/productLunBo/upload"/>" method="post" enctype="multipart/form-data">
                        <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                            ...
                            <tbody>
                                <tr class="message-unread">
                                    <td><input type="text" name="lName" id="lName" class="gui-input" maxlength="20"></td>
                                    <td><img src="<c:url value="/images/addImage.png"/>" width="93px" height="93px" id="img1"style="margin-bottom: 3px;"/><br/>
                                        <label class="button">
                                            <input type="file" name="header" id="gImage1" path="multipartFile" style="display: none">选择图片</input>
                                        </label>
                                    </td>
                                    <td><img src="<c:url value="/images/addImage.png"/> " width="93px" height="93px" id="img2"style="margin-bottom: 3px;"/><br/>
                                        <label class="button">
                                        <input type="file" name="header" id="gImage2" path="multipartFile" style="display: none">选择图片</input>
                                        </label>
                                    </td>
                                    <td>
                                        <img src="<c:url value="/images/addImage.png"/>" width="93px" height="93px" id="img3"style="margin-bottom: 3px;"/><br/>
                                        <label class="button">
                                        <input type="file" name="header" id="gImage3" path="multipartFile" style="display: none">选择图片</input>
                                        </label>
                                    </td>
                                    <td><img src="<c:url value="/images/addImage.png"/>" width="93px" height="93px" id="img4"style="margin-bottom: 3px;"/><br/>
                                        <label class="button">
                                        <input type="file" name="header" id="gImage4" path="multipartFile" style="display: none">选择图片</input>
                                        </label>
                                    </td>
                                    <td><img src="<c:url value="/images/addImage.png"/>" width="93px" height="93px" id="img5"style="margin-bottom: 3px;"/><br/>
                                        <label class="button">
