        ...
        <div class="panel heading-border">
            <div class="panel-body bg-light">
                ...
                <div class="panel-body pn">
                    <form action="<c:url value="/houtai/productLunBo/update"/>" method="post" enctype="multipart/form-data">
                        <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                            ...
                            <tr class="message-unread">
                                <input type="text" value="${productLunBo.lLno}" name="lLno" hidden>
                                <td><input type="text" value="${productLunBo.lName}" name="lName" id="lName" class="gui-input" maxlength="20"></td>
                                <td><img src="<c:url value="${productLunBo.lImage1}"/> " width="93px" height="80px" id="img1"style="margin-bottom: 3px;"/><br/>
                                    <label class="button">
                                        <input type="file" name="header" id="gImage1" path="multipartFile" style="display: none">选择图片</input>
                                    </label>
                                </td>
                                <td><img src="<c:url value="${productLunBo.lImage2}"/>" width="93px" height="80px" id="img2"style="margin-bottom: 3px;"/><br/>
                                    <label class="button">
                                        <input type="file" name="header" id="gImage2" path="multipartFile" style="display: none">选择图片</input>
                                    </label>
                                </td>
                                <td>
                                    <img src="<c:url value="${productLunBo.lImage3}"/>" width="93px" height="80px" id="img3"style="margin-bottom: 3px;"/><br/>
                                    <label class="button">
                                        <input type="file" name="header" id="gImage3" path="multipartFile" style="display: none">选择图片</input>
                                    </label>
                                </td>
                                <td><img src="<c:url value="${productLunBo.lImage4}"/>" width="93px" height="80px" id="img4"style="margin-bottom: 3px;"/><br/>
                                    <label class="button">
                                        <input type="file" name="header" id="gImage4" path="multipartFile" style="display: none">选择图片</input>
                                    </label>
                                </td>
                                <td><img src="<c:url value="${productLunBo.lImage5}"/>" width="93px" height="80px" id="img5"style="margin-bottom: 3px;"/><br/>
                                    <label class="button">
