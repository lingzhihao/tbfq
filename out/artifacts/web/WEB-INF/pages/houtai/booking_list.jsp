                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td class="hidden-xs"><span class="badge badge-danger mr10 fs11">${booking.bYduty}</span></td>
                            <td>
                                <a href="<c:url value="/houtai/booking/to_detailed?bYno=${booking.bYno}"/>">查看详情</a>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
