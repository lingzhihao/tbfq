                    ...
                    <div class="panel-body bg-light">
                       ...
                       <%-- <div class=" section row">
                            <div class=" form-group col-md-6">
                                <input type="password" name="old" id="old" class="form-control gui-input" placeholder="原始密码...">
                        ...
                        <div class="section row">
                            <div class="form-group col-md-6">
                                ...
                                <label for="new1" class="field prepend-icon">
                                    <input type="password" name="new1" id="new1" class="form-control gui-input" placeholder="新密码...">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="new2" class="field prepend-icon">
                                    <input type="password" name="new2" id="new2" class="form-control gui-input" placeholder="重复密码...">
