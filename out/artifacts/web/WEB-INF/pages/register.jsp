...
<div class="container"
    ...
    <div class="row">
        ...
        <div class="col-md-8"
            ...
            <form action="/ling/register" method="post" class="form-horizontal" style="margin-top: 5px;">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" width="100"
                               style="background: url('/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0); height: 35px; width: 100px; color: white;">注册</button>
                    </div>
                </div>
            </form>
        </div>
